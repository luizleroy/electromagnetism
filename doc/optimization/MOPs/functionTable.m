...
switch func
    ...
    case 'FON'
        ...
        f(:,2) = 1 - exp(-f(:,2));
    case 'POL'
        display('POL: nonconvex and disconnected');
    ...
    case 'ZDT2'
        ...
        f(:,2)=g(:,1).*(1 - (x(:,1)./g(:,1)).^2);
    case 'ZDT3'
        display('ZDT3: convex and disconected');
    ...
    case 'ZDT4'
        ...
        f(:,2)=g(:,1).*(1 - sqrt(x(:,1)./g(:,1)));
    case 'ZDT6'
        display('ZDT6: nonconvex, nonunifromly and spaced');
