...
\\
A alocação de capacitores precisa ser menor que um determinado valor (no caso, 750 kVAr) ou um determinado número de bancos disponíveis (5 x 150 kVar). \textbf{Após esta etapa, apenas um banco foi alocado.}
\vspace{-3mm}
...
\vspace{-3mm}
\item Voltar ao passo e) enquanto for possível reduzir as perdas de potência ativa do sistema ou  o total dos bancos de capacitores instalados for menor do que 750 kVAr. Ou seja, o restante dos recursos disponíveis. \textbf{Nesta etapa foram alocados três dispositivos, totalizando 600 kVAr na rede.}
\end{enumerate}

As comparações encontram-se na \Tab \ref{tab_final_comparacao}.
...
\begin{table}[position specifier]
  ...
  \hline
   & Valor & Alocações\\
  \hline
  Por VDI & x,x & Barras m, n e p \\
	Por Perdas & x,x kVA & Barras m, n e p \\
	\hline
	PSO final & yy & xx \\
	Alg. guloso & xx & yy \\
  \hline
