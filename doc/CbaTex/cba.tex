...
função objetivo propsta para tal fim. Durante este trabalho leva-se em consideração a minimização das perdas ao longo da linha
dos alimentadores de energia após a inserção, nos devidos pontos, dos
equipamentos capacitivos. Na literatura este tipo de problema é conhecido como
...
Durante este trabalho foi utilizado apenas informações de carregamento elétrico
do circuito, impedâncias envolvidas e sua topologia. A contribuição do software desenvolvido é 
especificar os principais parâmetros de bancos de capacitores alocados, bem com sua posição de instalação ao longo de 
um alimentador de energia. Buscando otimizar Perdas Elétrica e Queda de Tensão ao longo da linha. 
...
\begin{itemize}
 ...
 aplicação detalhes tecnicos são requeridos para utlização do PSO. Muitas formas
