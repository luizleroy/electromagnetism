...
\begin{algorithm}[H]
	\begin{algorithmic}	
			...
			\State Realizar o cálculo do fluxo de potência e da função objetivo para todas as partículas;
	...
	\While{(não atingir critério de parada)}
		...
		\Else
			\State Atualizar o valor corrente de gbest com o valor de gbest da iteração anterior;
		\EndIf
	\EndWhile
