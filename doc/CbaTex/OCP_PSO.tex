...
\end{equation}
Na \Eq \ref{eq_vdi}, o somatório percorre todas as barras, calculando o erro quadrático médio entre o valor de tensão $V_{barra}$ (estimado pelo cálculo de fluxo por varredura) e a tensão nominal de projeto.
