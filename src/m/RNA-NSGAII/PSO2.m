function [s_gbest,gbest,d]=PSO2(rna,n_var,x_trein,y_trein)
...
% limites iniciais de posição e velocidade p/ as particulas
S_lim(1,:)=-2*ones(1,n_var);
S_lim(2,:)=2*ones(1,n_var);
